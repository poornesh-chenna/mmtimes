    ...
    <div id="contact" className="my-6">
      <div className="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white  rounded-md text-[#333] font-[sans-serif]">
          ...
          <div className="mt-12">
            <ul className="mt-3">
              <li className="flex items-center">
                ...
                <a
                  target="blank"
                  href="mailto:mmtimes2023@gmail.com"
                  className="text-[#007bff] text-sm ml-3"
                >
                  <small className="block">Mail</small>
                  <strong>mmtimes2023@gmail.com</strong>
                </a>
              </li>
            </ul>
            <ul className="mt-3">
        ...
        <form onSubmit={handleSubmit} className="ml-auo space-y-4">
          ...
          <button
            type="submit"
            className="text-white relative bg-[#007bff] hover:bg-blue-600 font-semibold rounded-md text-sm px-4 py-2.5 w-full items-center justify-center"
          >
            {isLoading && (
              <svg
                aria-hidden="true"
